...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Farzicoderxd")
BOT_USERNAME = getenv("BOT_USERNAME", "SWEETY_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME", "˹𝙺ɪsʜᴜ ✘ 𝙼ᴜsɪᴄ˼")
ASSUSERNAME = getenv("ASSUSERNAME", "SUKKU_Assis")
EVALOP = list(map(int, getenv("EVALOP", "5569528945").split()))
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOGGER_ID = int(getenv("LOGGER_ID", -1002150699990))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Sumitmeena12/KISHU-X-MUSIC/edit/master/config.py")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/163bfac7aed8a92c47d0d.jpg"
)
PING_VID_URL = getenv(
    "PING_VID_URL", "https://telegra.ph/file/163bfac7aed8a92c47d0d.jpg"
)
